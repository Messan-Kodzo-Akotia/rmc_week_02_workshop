...
```{r}
print("In Senegal and Togo there is a notable downward trend in DALY burden, with a slight increase observed around 1999. In contrast, American Samoa exhibited a slower decline in DALY burden over the same period.")
```
